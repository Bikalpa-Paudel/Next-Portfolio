  ...
  return (
    <section className={style.home}>
      <div className={style.left}>
        ...
        <div className={style.welcome}>Frontend Developer</div>
        ...
        <p className={style.info}>
          ...
          and have a strong desire to expand my expertise into backend and other
          areas of software development in the future.
        </p>
      ...
      <div className="relative flex-[2] -z-10">
        <Image src={Gif} alt="programming gif" fill={true}/>
      </div>
    </section>
  );
}
